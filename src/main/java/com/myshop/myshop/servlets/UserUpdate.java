        ...
        try  {
            ...
            User user = (User)httpSession.getAttribute("currentUser");
                  ...
                  if(deleteId == 0){
                      ...
                      userDao.updateUser(userId,address);
                      httpSession.setAttribute("message", "User details are updated");
                    ...
                    return;
                      ...
                      SendMail.sendEmail("Your Account is successfully removed", "Account remove frem myshop", user.getUserEmail(), "saurabasak90@gmail.com");
